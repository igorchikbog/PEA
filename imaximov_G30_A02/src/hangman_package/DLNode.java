...
/**
 * The structure of a node in the simple doubly linked list introduced in the
...
public class DLNode<E> extends SLNode<E> implements Serializable {
	 ...
	 * <code>theElement</code>, whose predecessor is <code>predecessor</code> and
	 * whose successor is <code>successor</code>.
	 * 
	 ...
	 */
	public DLNode(E theElement, DLNode<E> thePredecessor, DLNode<E> theSuccessor) {
