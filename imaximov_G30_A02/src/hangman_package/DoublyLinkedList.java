...
public class DoublyLinkedList<E> implements Serializable {
	 ...
	 * 
	 * @param e the element to add
	 * @param p position to insert <code>e</code>; must be in the range 0 to
	 *          <code>this.size()</code>.
	 * @throws IndexOutOfBoundsException if <code>p</code> is outside the range 0 to
	 ...
	 * @throws IndexOutOfBoundsException if the index p is outside the range 0 to
	 *                                   <code>length - 1</code>.
	 */
